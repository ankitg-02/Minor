...
-- ========== FINAL JOIN WITH ASSET MASTER (MCR mapping & names) ==========
final_prep AS (
  SELECT
    a.scheme,
    am.scheme_name,
...
-- ========== FINAL SELECT: compute AUM columns in INR Cr ==========
SELECT
  ...
  -- PREVIOUS QUARTER AUM as per requirement:
  -- for Q1 this will be 0 because prev_open_* CTEs return no rows when fiscal_quarter = 1
