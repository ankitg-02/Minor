-- ===========================================================
-- Dynamic Quarterly AUM Report (FY: April - March)
-- Rectified logic for "AUM as on last day of previous quarter"
-- Works dynamically for all quarters based on report_month/year
-- ===========================================================

WITH params AS (
  SELECT
    -- >>>>> CHANGE THESE TO CURRENT QUARTER <<<<<
    -- Example: Q1 = '04'  Q2 = '07'  Q3 = '10'  Q4 = '01'
    '07' AS report_month,
    '2025' AS report_year
),

-- derive current & previous quarter end dates dynamically (FY Apr-Mar)
dates AS (
  SELECT
    report_month,
    report_year,
